...
> **Personal note:** I had to use Python 3.10 (not 3.11+) to avoid a compatibility issue with the CUDA extensions during `pip install`. If you hit build errors, try downgrading your Python version first.
